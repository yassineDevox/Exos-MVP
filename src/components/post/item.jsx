  ...
  return (
    <article className="p-2 bg-white ">
      ...
      <div className="post-body">
        <span
          className={
            post.matiere == "Mathématique" ? "badge bg-info" : "d-none"
          }
        >
          MATH
        </span>
        <span
          className={
            post.matiere == "Physique-Chimie" ? "badge bg-primary" : "d-none"
          }
        >
          PHY
        </span>
        <span
          className={post.matiere == "AUTRE" ? "badge bg-warning" : "d-none"}
        >
          AUTRE
        </span>
        <span className={post.matiere == "Svt" ? "badge bg-success" : "d-none"}>
          SVT
        </span>
        <span
          className={
            post.matiere == "Informatique" ? "badge bg-secondary" : "d-none"
          }
        >
          INFO
        </span>
